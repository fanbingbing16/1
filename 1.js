...
[
	{
		...
		"data": {
			"list": [
				{ "desc": "彭聃龄.普通心理学.北京:北京师范大学出版社,1987.", },
				{ "desc": "许政援.儿童发展心理学.长春:吉林教育出版社,1991.", },
				{ "desc": "Riese ML.Neonatal temperament in full-term twin pairs discor dant for birthweight.J Dev Behav Pediatr , 1994, 15(5):342 ～ 347.", },
				{ "desc": "Pauli .Behavioral markers of premature infants.Psychother Psychosom MedPsychol ,1995 , 45(5):153～ 159.", },
				{ "desc": "张劲松.北京市 3 ～ 7 岁儿童气质特点及类型分布探讨.中国心理卫生杂志, 1995 ,9(6):241 ～ 242.", },
	...
	},
	{
		...
		"data": {
			"list": [
				{
					"desc": 'Mclntyre R,Kennedy S,Bagby RM,et al.Assessing full remission[].Journal of Psychiatry and Neuroscience.2002'
				},
				{
					"desc": 'Connor,K. M.,Davidson,J. R. T.,Churchill,L. E.,Sherwood,A.,Foz,E.,Weisler,R. H.Psychometric properties of the Social Phobia Inventory (SPIN)[].British Journal of Psychiatry.2000'
				},
				{
					"desc": 'Connor KM,Kobak KA.Mini-SPIN:A brief screening assessment for generalized so-cial anxiety disorder[].Depression and Anxiety.2001'
				},
				{
					"desc": '李夏.心理护理干预改善焦虑症患者睡眠质量的效果分析[J].心理月刊,2020,0(4):80-80. '
				},
				{
					"desc": '韩慧琴,陈珏,谢斌.新型冠状病毒肺炎患者治愈后的心理问题和干预策略建议[J].上海医学,2020(3):175-180. '
				},
	...
	},
	{
		...
		"data": {
			"list": [
				{
					"desc": '谢莉.婴儿神经心理发育的影响因素分析[J].中国妇幼保健，2018，33（12）：2719-2722.'
				},
				{
					"desc": '郑慕时，冯玲英，刘湘云，等.0～6 岁儿童智能发育筛查测验全国城市常模的制定[J]. 中华儿科杂志，1997，48（3）：6-9.'
				},
				{
					"desc": '何守森，汪翼，孙宗花，等.0～1 岁儿童家庭养育环境量表的编制及其信度效度研究[J]. 中国儿童保健杂志，2008，16（5）：503-506.'
				},
				{
					"desc": '徐云，李幸，余小敏．成都地区亲子沟通现状沟通[J]. 中国妇幼保健，2013，28（27）：4509-4510.'
				},
				{
					"desc": '刘靖.对隔代抚养家庭儿童亲子关系的社会工作实务研究[D].吉林：吉林大学，2014.'
				},
				{
					"desc": '谢银花 .早期教育在婴幼儿保健门诊中的应用 [J].中国社区医师，2016，32（31）：192，194'
				},
				{
					"desc": 'Brown HK，Speechley KN，Macnab J，et al.Mild prematu⁃rity，proximal social processes，and development[J].Pediat⁃rics，2014，134（3）：814-824'
				},
				{
					"desc": 'Raz S，Newnan JB，Debastos AK，et al. Postnatal growthand neuropsychological performance in preterm-birth pre⁃schoolers[J].Neuropsychol，2014，28（2）：188-201.'
				},
				{
					"desc": 'Hernández G，Vaquero C，González P，et al.Effect ofpostextubation high-flow nasal cannula vs conventionaloxygen therapy on reintubation in low-risk patients[J].JA⁃MA，2016，315（13）：1354-1361.'
				}
...
a = a.map((item1, index) => {
	...
	item1 = item1.map(item => {
		let bbb = new Set()
		if (item.style === 'cs5') {
			item.data.list = item.data.list.filter(element => {
				console.log(element, 'element', bbb)
				if (bbb.has(element.desc)) {
					return false
				} else {
					bbb.add(element.desc)
					if (element.data) {
						return false
					}
					return true
...
function ccc() {
	bbb = []
	b.map((item, index) => {
		sql = `update lb_info set detail_json='${JSON.stringify(a[index])}' where name='${item}';`
		bbb.push(sql)
	})
	console.log(bbb, 'bbb')
}
[
	[
		{
			"data": {
				"list": [
					"该量表由最认识孩子的抚育者依据孩子近来一年的表现，与他(她) 同龄的其余孩子比较以后评定。",
					"采纳 7点量表进行评分，每个条目是一个陈说句。认识孩子的气质，父亲母亲能够依据孩子的气质特色，提出合理的希望、要求，追求合适孩子本性的个性化修养方式，实行针对性的教育指引。",
					"这样做，既有益于完美孩子的性格，促使孩子初期心理健康发育:也有益于年青父亲母亲除去育儿忧虑，建立自信的修养信念，形成和睦亲近的亲子关系。"
				],
				"title": "关于测试"
			},
			"style": "cs7"
		},
		{
			...
			"data": {
				"title": "参考文献",
				"list": [{ "desc": "彭聃龄.普通心理学.北京:北京师范大学出版社,1987.", },
				{ "desc": "许政援.儿童发展心理学.长春:吉林教育出版社,1991.", },
				{ "desc": "Riese ML.Neonatal temperament in full-term twin pairs discor dant for birthweight.J Dev Behav Pediatr , 1994, 15(5):342 ～ 347.", },
				{ "desc": "Pauli .Behavioral markers of premature infants.Psychother Psychosom MedPsychol ,1995 , 45(5):153～ 159.", },
				{ "desc": "张劲松.北京市 3 ～ 7 岁儿童气质特点及类型分布探讨.中国心理卫生杂志, 1995 ,9(6):241 ～ 242.", },]
	...
	[
		{
			"data": {
				"desc1": "焦虑症是儿童及青少年常见的精神疾病, 而且有超过半数的儿童有焦虑情绪体验。焦虑被认为是一种贯穿于成长发育全过程的正常情绪，比如对于受伤和疾病的焦虑，这种害怕和焦虑不会影响儿童的社会功能，但部分儿童体验到过度的焦虑情绪并因此降低了生理及社会功能，演变为情绪障碍，该问题会持续到青年期或成年期。相关研究表明，焦虑性情绪障碍受到生物学因素和环境因素的交互作用。及早发现儿童的焦虑情绪风险，从而指导家长改善养育方式有助于改善儿童的焦虑情绪。",
				"desc2": "儿童焦虑性情绪障碍筛查表(The Screen for Child Anxiety Related Emotional Disorders，SCARED)由Birmaher于1997年编制，用于8～18岁儿童青少年焦虑障碍的自评，由38个条目组成，通过因子分析提取五个因子，平行于DSM-Ⅳ对焦虑障碍的分类，包括：躯体化/惊恐、广泛性焦虑、分离性焦虑、社交恐怖、学校恐怖。另外，从每个因子中提取负荷最高的一项，组成简明焦虑量表。",
				"title": "关于焦虑症"
			},
			"style": "cs6"
		},
		{
			"data": {
				"list": [
					{
						"desc": "本测评共计41道题，测试时间需 5~30 分钟。"
					},
					{
						"desc": "请在心态平和及时间充足的情况下开始答题。"
					},
					{
						"desc": "题目的答案无对错之分，你不需要考虑哪个答案（应该）更好，而是凭你心里的第一反应做出选择。"
					}
				],
				"title": "测试须知"
			},
	...
	[
		{
			"data": {
				"list": [
					...
					{
						"desc": "容易激动,情绪波动强烈，总是和我们唱反调"
					},
					{
						"desc": "乱发脾气、虚荣心强、听不进正确的意见跟建议。"
					},
					{
						"desc": "厌学不想去上学。"
					},
					{
						"desc": "天天想着手机。有头痛肚子痛的症状。"
					}
				],
				"title": "你家孩子最近一段时间有没有这种情况"
			},
			"style": "cs4"
		},
		{
			"data": {
				"desc1": "儿童抑郁症会让孩子感到自己无能、无力，自我价值感降低，从而影响其正常的学习和生活。社交能力下降：儿童抑郁症会影响孩子与他人的交流和沟通，导致社交能力下降，孩子更容易与人产生冲突和矛盾。严重的可能导致孩子产生自杀念头和行为，这对孩子的生命安全带来了极大的威胁。",
				"desc2": "儿童抑郁障碍自评量表（Depression Self-rating Scale for Children, DSRSC）是由P.Birleson于1981年根据成人抑郁症诊断标准制定，它是适用于儿童抑郁症的临床评估的量表。该量表适用于7岁～13岁的儿童对自己抑郁症状的自评，共有18个条目。该量表条目少且简单，也没有生僻词句，适合8岁（三年级）以上的儿童。",
				"title": "抑郁症的危害"
			},
			"style": "cs6"
		},
		{
			"data": {
				"list": [
					{
						"desc": "遗传因素：有亲人之前曾经有过抑郁症。"
					},
					{
						"desc": "儿童处于生长发育阶段，身体、心智还没有发育成熟，很容易受到外界影响。"
					},
					{
						"desc": "社会心理因素：家庭变故，或处在不良的成长环境。"
					},
					{
						"desc": "放假玩久了，突然上学不适应，学习压力太大。"
					},
					{
						"desc": "家庭因素：如果父母经常吵架，长期处于不和睦的家庭氛围中。"
					},
					{
						"desc": "父母家庭教育方式比较严苛，从不鼓励一直否定。"
					},
					{
						"desc": "本身存在生理缺陷，长期受到身边人群的嘲笑，或者本身性格内向，不善与人沟通等。"
					}
				],
				"title": "抑郁症的原因"
			},
		...
		},
		{
			"data": {
				"list": [
					...
					{
						"desc": "抑郁如何影响你的生活?哪些事情会诱发、加重你的抑郁?",
						"title": "分析: "
					},
					{
						"desc": "你可以如何走出抑郁困境?",
		...
		},
		{
			"data": {
				"list": [
					{
						"desc": "Birleson, P., Hudson, I., Buchanan, D. G., & Wolff, S. (1987). Clinical evaluation of a self‐rating scale for depressive disorder in childhood (Depression Self‐Rating Scale). Journal of Child Psychology and Psychiatry, 28(1), 43-60."
					},
					{
						"desc": "Kovacs, M. (1992). Children’s Depression Inventory (CDI) manual. Multi-Health Systems, Inc."
					},
	...
	[
		{
			"data": {
				"list": [
					{
						"desc": "由贝鲁蒙特等人与1994年编制，适用于4岁以上儿童自闭症的筛查。项目来自自闭症诊断访谈量表修订版。",
						"title": "量表特点"
					},
					{
						"desc": "该评估包括40个项目，评价儿童的社会交互作用、语言和交流、重复和刻板行为等。",
						"title": "量表内容"
					}
				]
			},
	...
	[
		{
			"data": {
				"list": [
					{
						"desc": "儿童饮食行为量表由英的Jane  Wardle 等于2001年运用病因学、心理学和抑制理论,按照标准化量表编制流程创建。"
					},
					{
						"desc": "是一个有效的测量工具,可用于儿童饮食行为评价以及饮食行为与肥胖的相关性研究。"
					},
					{
						"desc": "被用于比较消瘦和肥胖父母的儿童食欲偏好的差异,探索儿童饮食行为随时间变化的连续性和稳定性,研究先天身材矮小儿童的饮食行为。"
					},
					{
						"desc": "CEBQ具有较好的内容效度和标准关联效度,是基于父母报告儿童饮食行为的有价值测量工具。"
					}
				],
				"title": "关于测试"
			},
	...
	[
		{
			"data": {
				"desc1": "儿童困难问卷（QCD）是一种用于评估儿童心理健康的测评工具。它由30项问题组成，覆盖了儿童的情绪、行为、学习能力、社会功能、自尊、情绪管理等方面。",
				"desc2": "通过该问卷，可以对儿童的心理健康状况进行评估，以便及时发现儿童是否存在心理问题，从而及时采取有效的治疗措施。"
			},
			"style": "cs6"
		},
		{
			"data": {
				"list": [
					"儿童困难问卷（QCD）可以由儿童本人或家长进行测试。",
					"如果由儿童本人完成，则需要儿童有足够的理解能力和语言能力来完成问卷。",
					"如果由家长完成，则需要家长对儿童的心理状况有足够的了解，以便能够准确地回答问题。"
				]
			},
			"style": "cs7"
		},
	...
	[
		...
		{
			"data": {
				"desc1": "阿斯伯格综合征属于孤独症谱系障碍的一种，具有孤独症的典型表现，即社会交往与沟通能力低下，孤独少友，兴趣狭窄，动作和行为刻板等，但没有明显的语言发育障碍和智能障碍。",
				"desc2": "目前该病病因不明。但研究显示，遗传基因、生物化学、过滤性病毒、妊娠期和分娩时出现的一些问题及环境问题都可能是阿斯伯格综合征的原因。罹患阿斯伯格综合征的概率为0.07%，即平均每一万名新生儿会有7名是患者。",
				"title": "阿斯伯格综合征是什么"
			},
			"style": "cs6"
		},
		{
			"data": {
				"list": [
					"很多家长容易把阿斯伯格症和自闭症容易混淆，其实阿斯伯格症和自闭症是有区别的。两者的共同点是患者性格比较孤僻，交际比较困难，容易冲动；但是阿斯伯格症患者没有语言方面和认知方面的障碍，还有的患者在某些方面具有非凡的天赋。。",
					"如果测试结果表示有风险，建议到权威医院检查。"
				],
				"title": "测试须知"
			},
			"style": "cs7"
	...
	[
		{
			"data": {
				"desc1": "高功能自闭症大约占自闭症人群的10%左右，属于自闭症患者中的高功能人群，高功能自闭症患者有自闭症的症状表现，但是患者的智商高于其他自闭症患者，甚至高于正常人群。患有高功能自闭症的人通常智力正常，有时甚至异常聪明。这些特征可以掩盖某些症状。因为他们在学校表现良好、有效沟通和通过智商测试的能力令人印象深刻——所以在寻找孩子异常问题或行为的原因时可能会让父母和老师走上错误的道路。",
				"desc2": "高功能自闭症儿童自测表是根据亚斯伯格症筛检表(Screeening Questionnaire-Asperger Syndrome)(Ehlers & Gillberg,1993)发展而成"
			},
			"style": "cs6"
		},
		{
	...
	[
		{
			"data": {
				"desc1": "过敏是儿童常见的三大疾病之一，近年来发病率不断升高。目前对于过敏性疾病还无有效的治疗方法因此预防非常重要。",
				"desc2": "本问卷能够帮助您了解宝宝将来发生过敏的风险程度，更好的针对过敏进行有效的预防。",
				"title": "预知过敏风险"
			},
			"style": "cs6"
		},
	...
	[
		{
			"data": {
				"desc1": "瑞文标准推理测验(简称 SPM) 是国际上广受认可的智力测验1具。由英国心理学家瑞文 (J.C.Raven) 于1938年创制，在世界各国沿用至今。它是一种纯粹的非文字智力测验，所以广泛应用于无国界的智力/推理能力测试。瑞文测验的编制在理论上依据斯皮尔曼(CSpearman) 的智力二因素论，该理论认为智力主要由两个因素构成，其中一个是普通因素，又称（G）因素，它可以渗入所有的智力活动中，每个人都具有这种能力，只是水平上有差异，另一个是特殊因素称（S）因素，这类因素种类多，与特定训练有高相关。",
				"desc2": "瑞文的推理测验是测量（G）因素的有效工具，尤其与测量人的问题解决、清晰知觉和思惟、发现和利用自己所需信息以及有效地适应社会生活的能力有关。 本测验一共由60张图组成，分为5个单元，分别考察了知觉辨别、类同比较、比较推理、系列关系推理、抽象推理运算等方面的思维能力。",
				"title": "关于测试"
			},
			"style": "cs6"
		},
		{
			"data": {
				"list": [
					"本测验不受文化水平和语言的限制，看图作答即可测出您的智力水平。此外，您还会得到相应的提升指导建议，通过训练让自己成为更聪明的人。"
				]
			},
			"style": "cs7"
		},
		{
			"data": {
				"list": [
					{
						"desc": "本测验没有严格的时间限制，但一般建议在20分钟左右完成。完成测评后，您答对的总分将会转化为同年龄组的百分比等级。"
					},
					{
						"desc": "适合年龄范围为6-70岁，结果与测评年龄息息相关，因此测评结束时需要输入您年龄，请填写真实的信息。"
					},
					{
						"desc": "智力测验与测试时的精神状态，周边环境等多种因素有关，波动范围大约在3至15分左右。经常做智力游戏题的人，在各种智力测验中的分数都有可能提高。"
					},
					{
						"desc": "本智力测验分数不能代表未来成就大小。"
					}
				]
			},
			"style": "cs4"
	...
	[
		...
		},
		{
			"data": {
				"list": [
					{
						"desc": "根据国内学者的研究体会，它对于神经症及综合医院住院病人或心理咨询门诊的受检者，都有较好的自评效果，是能很快了解病人自觉症状的有力工具。"
					},
					{
						"desc": "请根据最近一星期以内你的实际感受，选择一个与你的情况最相符合的答案。"
					}
				],
				"title": "具体测试事项"
			},
		...
		},
		{
			"data": {
				"list": [
					"症状自评量表（Self-reporting Inventory)，又名90项症状清单（SCL-90），时也叫做Hopkin‘s症状清单。于1975年编制，其作者是德若伽提斯（L.R.Derogatis)。该量表共有90个项目，包含有较广泛的精神病症状学内容，从感觉、情感、思维、意识、行为直至生活习惯、人际关系、饮食睡眠等，均有涉及，并采用10个因子分别反映10个方面的心理症状情况。"
				],
				"title": "量表简介"
			},
			"style": "cs7"
	...
	[
		{
			"data": {
				"desc1": "抑郁症是一种常见的心理障碍，其特征是情绪低落、兴趣和活力减退、自我价值感降低、注意力和记忆力减退、睡眠障碍等。抑郁症的病因可能与生物学、心理社会以及遗传因素有关。治疗抑郁症的方法包括药物治疗、心理治疗、认知行为疗法等，同时也需要健康的生活方式和家庭、社会的支持。",
				"desc2": "PHQ-9是国际通用抑郁检测量表之一；共有9个项目，根据最近两个星期内的实际感受，来选择一个与实际情况最符合的答案，答案没有对错，真实反应自己的感受就好。"
			},
			"style": "cs6"
		},
		{
	...
	[
		{
			"data": {
				"list": [
					"康纳儿童行为评定量表由美国的Conners编制，是全世界应用范围最广的儿童行为评定量表，问卷问题共48项，能较好地反映儿童的注意力表现、多动症表现、攻击性行为、焦虑紧张、心神障碍及社交等问题。请您根据孩子在最近一年中的表现，选择最符合他/她的那个情况，这些选项的程度为:"
				],
				"title": "关于测评"
			},
			"style": "cs7"
		...
		},
		{
			"data": {
				"list": [
					"儿童在社会化发展的阶段中，通过与同伴、老师、父母的交往，他们逐步发展社会生活适应能力，逐渐学会克制自己的欲望。但是，由于儿童的自我价值体系尚未稳定的建立起来，所以他们很容易的受到外部环境的干扰，在缺乏正确引导的情况下，就会出现很多问题行为。Conners儿童行为量表主要用来筛选儿童的问题行为，特别是多动症问题；主要有父母评、教师评以及父母教师评问卷三种形式。　"
				],
				"title": "量表简介"
			},
			"style": "cs7"
	...
	[
		{
			"data": {
				"desc1": "儿童孤独症是广泛性发育障碍中最具代表性的疾病，常导致精神残疾（自闭症），给家庭和社会造成沉重的负担",
				"desc2": "改善儿童孤独症的关键是早期诊断和干预，目前针对婴幼儿的孤独症筛查手段较少，本测试针对1.5岁以内的新生儿孤独症筛查。一定要做到尽早发现，尽早干预。",
				"title": "可隐藏标题 上下两段文字"
			},
			"style": "cs6"
		},
		{
			"data": {
				"list": [
					{
						"desc": "0-18个月 婴幼儿孤独症筛查 (本测试)"
					},
					{
						"desc": "18个月-3岁 改良婴幼儿孤独症量表 45"
					},
					{
						"desc": "3-15岁 克氏孤独症行为量表 80"
					}
				],
				"title": "请根据不同年龄 选择不同的测试"
			},
			"style": "cs4"
		},
		{
			"data": {
				"list": [
					{
						"desc": "Lavelle TA，Weinstein M C ，New house JP，et al. Economic Burdenof Childhood Autism Spectrum Disorders ［J］ . Pediatrics，2014，133( 3) : 520 － 529."
					},
					{
						"desc": "陶国泰，杨晓玲 . 走出孤独的世界: 儿童孤独症释疑［M ］ . 北京:人民卫生出版社，2000: 114 － 118."
					},
					{
						"desc": "冯雅静，王雁 . 孤独症儿童的诊断工具: 现状及展望［J］ . 中国特殊教育，2012，( 9) : 45 － 52."
					},
					{
						"desc": "龚郁杏，刘靖，李长璟，等 . 改良婴幼儿孤独症量表中文版的信效度［J］. 中国心理卫生杂志，2011，25( 6) : 409 － 414."
					},
					{
						"desc": "龚郁杏，刘靖，李长璟，等 . 改良婴幼儿孤独症量表中文修订版的信效度［J］. 中国心理卫生杂志，2012，26( 6) : 476 － 480."
					},
					{
						"desc": "American Psychiatric Association. Diagnostic and Statistical M anualof M ental Disorders ( DSM -IV ) ［M ］ . Washington， DC : AmericanPsychiatric Association，1994."
					},
					{
						"desc": "Williams J， Brayne C. Screening for autism spectrum disorders:w hat is the evidence［J］？ Autism ，2006，10( 1) : 11 － 35."
					},
					{
						"desc": "Filipek PA，Accardo PJ，Baranek GT ，et al. The screening and diag-nosis of autistic spectrum disorders ［J］ . J Autism Dev Disord，1999，29( 6) : 439 － 484."
					},
					{
						"desc": "Senju A， Johnson M H. Atypical eye contact in autism : M odels，mechanisms and development"
					},
					{
						"desc": "Robins, D. L., Fein, D., Barton, M. L., & Green, J. A. (2001). The Modified Checklist for Autism in Toddlers: An initial study investigating the early detection of autism and pervasive developmental disorders. Journal of Autism and Developmental Disorders, 31(2), 131-144."
					},
	...
	[
		{
			"data": {
				"list": [
					"学龄前50项智能测验法，是全国儿童智能协作组拟定的智能测验方法之一。可以评定4～7岁儿童智能发育水平，为儿童入学准备提供参考依据"
				]
			},
			"style": "cs7"
		},
		{
			"data": {
				"list": [
					"50项量表是属于一种测查儿童综合性能力的筛查工具。内容为回答问题和操作两大类，包括：",
					"⑴自我认识能力",
					"⑵运动能力包括大运动及精细运动",
					"⑶记忆能力",
					"⑷观察能力",
		...
		},
		{
			"data": {
				"list": [
					{
						"desc": "方法简便易行，费时少，约15～20分钟。"
					},
					{
						"desc": "通过大量人群测查的结果，所得能力商呈正态分布，符合人群智能发展的客观规律。"
					},
					{
						"desc": "量表与国际上通用的韦氏学前儿童量表和丹佛发育筛选法均有较高的符合率，可以作为评定4～7岁儿童智能发育的一种较好的方法。"
					}
				],
				"title": "测验的优点"
			},
		...
		},
		{
			...
			"data": {
				...
				"list": [
					{
						"desc": "Sharma P, Gupta RK, Banal R, et al.. Prevalence and correlates of attention deficit hyperactive disorder (ADHD) risk factors among school children in a rural area of North India[J]. J Family Med Prim Care, 2020, 9(1): 115-118. DOI: 10.4103/jfmpc.jfmpc_587_19. "
					},
					{
						"desc": "Danielson ML, Visser SN, Chronis-Tuscano A, et al.. A national description of treatment among United States children and adolescents with attention-deficit/hyperactivity disorder[J]. J Pediatr, 2018, 192: 240-246.e1. DOI: 10.1016/j.jpeds.2017.08.040."
					},
					{
						"desc": "Coghill D, Hodgkins P. Health-related quality of life of children with attention-deficit/hyperactivity disorder versus children with diabetes and healthy controls[J]. Eur Child Adolesc Psychiatry, 2016, 25(3): 261-271. DOI: 10.1007/s00787-015-0728-y.  "
					},
					{
						"desc": "Daley D, Jones K, Hutchings J, et al.. Attention deficit hyperactivity disorder in pre-school children: current findings, recommended interventions and future directions[J]. Child Care Health Dev, 2009, 35(6): 754-766. DOI: 10.1111/j.1365-2214.2009.00938.x.  "
					},
					{
						"desc": "Wang TT, Liu KH, Li ZZ, et al.. Prevalence of attention deficit/hyperactivity disorder among children and adolescents in China: a systematic review and meta-analysis[J]. BMC Psychiatry, 2017, 17(1): 32. DOI: 10.1186/s12888-016-1187-9."
					},
					{
						"desc": "Pfiffner LJ, Rooney ME, Jiang YY, et al.. Sustained effects of collaborative school-home intervention for attention-deficit/hyperactivity disorder symptoms and impairment[J]. J Am Acad Child Adolesc Psychiatry, 2018, 57(4): 245-251. DOI: 10.1016/j.jaac.2018.01.016.  "
					},
					{
						"desc": "Posner J, Polanczyk GV, Sonuga-Barke E. Attention-deficit hyperactivity disorder[J]. Lancet, 2020, 395(10222): 450-462. DOI: 10.1016/S0140-6736(19)33004-1.  "
					},
				]
			}
		}
	...
	[
		{
			"data": {
				"desc1": "气质就是孩子在日常生活中对不同情形的行为反应方式，它与生俱来，无好坏之分，但是每个孩子的气质特点有所差异，针对不同的气质特点需要有不同的教养方法。由这份气质量表可以使我们得知您孩子的气费特点，帮助您更了解您的孩子。 找出更适合您孩子的教养方式。",
				"desc2": "本测试由最了解孩子的抚养者进行填写。测验者请提前准备好时间，测试过程不要被打断。开始测验前，请保证周围环境足够安静，当前无其他干扰因素影响测验的进行。"
			},
			"style": "cs6"
		},
		{
			"data": {
				"list": [
					"小婴儿气质问卷（Early Infancy Temperament Questionnaire，ETTQ）是由Medoff-Cooper制订于1985年至1990年，93年发表，共计76个条目，适用1~4个月婴儿（即出生后满1个月至满4个月的小婴儿）。在2000年，由邹小兵、宁方芹等人将其引入中国，并进行了适合中国本土化的修订和标准化后编制而成的，目前已经广泛应用在幼儿教育领域多年。"
				]
			},
			"style": "cs7"
		},
	...
	[
		{
			"data": {
				"list": [
					"作为国内第一套适合考察幼儿个性心理发展的量表，是国内专家根据美国Fullard、Carey等人设计的1-3岁幼儿气质量表（TTS）为蓝本，进行了适合中国本土化的修订和标准化后编制而成的。CTTS是由97个问题组成。这些问题代表儿童日常生活中的行为方式。由家长针对这些项目，以六个分级对孩子进行评分。"
				]
			},
			"style": "cs7"
		},
	...
	[
		{
			"data": {
				"desc1": "儿童孤独症是广泛性发育障碍中最具代表性的疾病，常导致精神残疾（自闭症），给家庭和社会造成沉重的负担",
				"desc2": "改善儿童孤独症的关键是早期诊断和干预，目前针对婴幼儿的孤独症筛查手段较少，本测试针对18个月-3岁儿童孤独症筛查。一定要做到尽早发现，尽早干预。",
				"title": "18个月-3岁儿童孤独症筛查"
			},
			"style": "cs6"
		},
		{
	...
	[
		{
			"data": {
				"list": [
					"该量表是在国家（七五）攻关科研项目（中国0—14岁儿童智力低下流行病学调查）的成果基础上，经过多年临床检验并修订完善而成的。自在全国推广应用以来，得到了广泛认可，被公认是一种简便、可靠、操作性强的行为评定量表，由第二次全国残疾人抽样调查智力残疾评定专家组主持认定，具有较大实用价值。"
				]
			},
			"style": "cs7"
		},
	...
	[
		{
			"data": {
				"list": [
					"儿童行为量表主要用于筛查儿童的行为问题和社交方面的能力，由熟悉儿童的 家长 或 监护人 填写，建议为长期和儿童生活在一起的父母填写。"
				],
				"title": "关于测评"
			},
			"style": "cs7"
		},
		{
			"data": {
				"list": [
					{
						"desc": "包括：参考体育运动，参加课外活动，参加家务劳动，与他人相处，在学校的学习情况。需要监护人细致观察，也需要适当和儿童交流，去了解儿童的心理活动。",
						"title": "社会能力"
					},
					{
						"desc": "根据相关行为问卷来分析，其内容包括：社交退缩，思维问题，遵守纪律，抑郁焦虑，多动，攻击性行为，强迫性行为等。在生活中也需要监护人及时爱抚，以缓解儿童的焦虑感，对于不当的行为应该予以解析和引导，而不是斥责打骂，否则只能会让问题变得愈发严重，在监护人觉察问题异常时，应该及时求助于专业的心理医生。",
						"title": "行为问题"
					}
				],
				"title": "量表主要包含"
		...
		},
		{
			"data": {
				"list": [
					{
						"desc": "建议由生活在一起的父母，或者是监护人操作填写。"
					},
					{
						"desc": "所有问卷题请根据最近6个月的行为表现来评定。"
					},
					{
						"desc": "量表得分越高，则表示儿童行为问题越大。"
					},
					{
						"desc": "量表测试仅供参考，如果有异常提示，务必及时就医。"
					}
				],
				"title": "量表操作注意"
			},
	...
	[
		{
			"data": {
				"list": [
					"这是一份关于注意力的测试，所有题目都没有（正确答案），请凭读完每一句子后的第一印象选择最贴近自己情况的选项。虽然没有时间限制，但尽可能地争取以较快的速度完成，愈快愈好。 请不要遗漏，务必回答每一个问题。"
				],
				"title": "评测须知"
			},
			"style": "cs7"
		},
		{
			"data": {
				"list": [
					{
						"desc": "张志华, 罗剑文, 陈兴生, 等. 中国儿童注意力水平测评量表的编制[J]. 中国心理卫生杂志, 2009, 23(12): 905-910."
					},
					{
						"desc": "张志华, 罗剑文, 陈兴生, 等. 中国儿童注意力水平测评量表的信度和效度研究[J]. 中国临床心理学杂志, 2010, 18(1): 1-4."
					},
					{
						"desc": "王兆平, 刘海光, 邓雪峰, 等. 中国儿童注意力水平测评量表在ADHD筛查中的应用[J]. 中国儿童保健杂志, 2015, 23(3): 266-269."
					},
					{
						"desc": "肖建华, 张海峰, 陈兴生, 等. CCAS在学前儿童注意力水平测评中的应用研究[J]. 中国儿童保健杂志, 2011, 19(5): 426-429."
					},
					{
						"desc": "刘娜, 王海燕, 王红, 等. CCAS在学前儿童注意力水平测评中的应用[J]. 中国儿保杂志, 2013, 21(4): 297-300."
					},
					{
						"desc": "以下是中国儿童注意力水平测评量表的参考文献："
					},
	...
	[
		...
		{
			"data": {
				"desc1": "能够导致孤独症发生的病因有很多，包括遗传学因素、病毒与免疫学因素、神经生化与神经内分泌因素、脑结构与脑电生理学因素、围生期因素、社会心理学因素等。",
				"desc2": "孤独症属于广泛发育性疾病，是其中最常见、最有代表性的疾病，多起病于婴幼儿时期，以社会交往障碍、语言交流障碍、刻板重复行为作为主要临床表现，约70%的患儿同时伴有精神发育迟滞",
				"title": "可隐藏标题 上下两段文字"
			},
			"style": "cs6"
		},
		{
			"data": {
				"list": [
					"克氏孤独症行为量表(ClancyAutism Behavior Scale，CABS)是1969 年由 CLANCY等编制,共14个项目取7分为划分点能有效区分孤独症儿童和正常儿童。",
					"1983年台湾学者谢清芬等对该量表进行修订，将原来的二分法修改为（从不0分）（偶尔1分）和（经常2分三种反应强度并认为总分214分为初步筛选孤独症的标准。",
					"该量表为目前国内外使用较多的孤独症筛查诊断量表之一，对孤独症的诊断敏感度高，且反映常见的行为问题，与临床诊断符合率达 95%,可作为诊断孤独症的重要依据。该量表被临床医生广泛采用。"
				],
				"title": "测试介绍"
			},
			"style": "cs7"
	...
	[
		{
			"data": {
				"desc1": "良好家庭教育环境，似春日里和煦的暖风，冬日里温柔的阳光，滋润着孩子的心田沐浴着健壮的幼苗。没有充足的阳光、水分、土壤、空气，植物将无法成活;没有良好的家庭教育环境，孩子的身心发展将会受到影响。良好的家庭教育环境是孩子健康成长所必需的（土壤）。有了这块养料充足、根基肥沃的土壤，再加上充足的光照，适宜的空气和水分，家园里的小苗才能茁壮成长。",
				"desc2": "教育专家调研发现:绝大多数（成绩不好的儿童），不是因为智力方面的差异造成的而是受（不良家庭环境）的影响。不良家庭环境带给孩子的影响，不仅体现在学习、生活健康等方面，更为严重的是对孩子的情感、个性、品德等方面造成恶劣影响。"
			},
			"style": "cs6"
		},
		{
	...
	[
		{
			"data": {
				"list": [
					"WFIRS-P由儿童父母或看护人进行评定,包括50个项目,涵盖6个功能领域:家庭、学习和学校、生活技能、儿童的自我观念、社会活动和冒险活动。1,评分方法 根据儿童最近一个月内的情绪、行为方面的情况对每个项目采用0(从不)、1(有时)、2(经常)、3(总是或频繁)进行四点评分。其中,生活技能分量表中的第2项（ 保持清洁）及社会活动分量表的第4项（参加课外活动）这两个条目为反向计分。WFIRS-P为Likert式量表,任一项目评分为2或3代表此项目临床上存在缺陷。各分量表每一个项目得分相加后得到各维度 的量表分,并计算量表总分和平均分。含有不适用条目,计算平均分、总分时,不参与评分。记录量表中得分为2或3的项目数或所有项目总分或平均分。"
				],
				"title": "测评详情："
			},
			"style": "cs7"
		},
		{
			"data": {
				"list": [
					{
						"desc": "Varni JW, Seid M, Kurtin PS. PedsQL 4. 0: reliability and validityof the Pediatric Quality of Life Inventory version 4. 0 generic corescales in healthy and patient populations [J]. Med Care, 2001, 39(8): 800 -812."
					},
					{
						"desc": " Riley AW, Forrest CB, Rebok GW, et al. The Child Report Form ofthe CHIP-Child Edition: reliability and validity [J]. Med Care,2004,42(3):221 -231."
					},
					{
						"desc": "Weiss MD, Brooks BL, Iverson GL, et al. 54 Annual meeting of American Academy of Child and Adolescent Psychiatry. Reliabilityand Validity of the Weiss Functional Impairment Rating Scale[ C]. American Academy of Child & Adolescent Psychiatry, Bos-ton,2007: 111."
					},
					{
						"desc": "Danckacrts M, Sonuga-Barke EJ, Banaschcwski T, et al. The quali-ty of life of children with attention deficit/hyperactivity disorder: asystematic review [J]. Eur Child Adolesc Psychiatry, 2010，19(2):83 -105."
					},
					{
						"desc": "Weiss MD, Gibbins C, Goodman DW, et al. Moderators and media-tors of symptoms and quality of life outcomes in an open-labelstudy of adults treated for attention-deficit/hyperactivity disorder[J.J Clin Psychiatry,2010,71(4): 381 - 390."
					},
					{
						"desc": " Maziade M, Rouleau N, Lee B,et al. Atomoxetine and neuropsy-chological function in children with attention-deficit/hyperactivitydisorder: results of a pilot study [J]. J Child Adolesc Psychophar-macol,2009,19(6):709 -718."
					},
					{
						"desc": "钱英, 杜巧新, 曲姗,等. Weiss功能缺陷量表父母版的信效度[J]. 中国心理卫生杂志, 2011, 25(10):5."
					}
				],
				"title": "参考文献"
			},
	...
	[
		{
			"data": {
				"desc1": "小孩子看起来很机灵，他的发育程度跟他的月龄是否符合呢？测试一下吧。",
				"desc2": " 该表由6个月至24个月龄孩子的父母或直接照顾者填写。仔细阅读每一个题目，按照你孩子的实际情况回答。",
				"title": "宝贝够不够机灵"
			},
			"style": "cs6"
		},
		{
			"data": {
				"list": [
					{
						"desc": "不同月龄有些选项不通过是正常的"
					},
					{
						"desc": "3个月后再测试一下，小孩子长很快"
					},
					{
						"desc": "结果有异常建议到妇幼复评"
					}
		...
		},
		{
			"data": {
				"list": [
					"目的为了了解发育迟缓(DD)、特殊语言发育障碍(SLI)、孤独症谱系障碍(ASD)儿童使用婴幼儿沟通和象征行为发展量表(CSBS-DP-ITC)筛查结果的差异,为ASD的早期一级筛查提供指导。方法采用回顾性分析方法,对2013年1月至2014年12月就诊于南方医科大学附属深圳市妇幼保健院儿童心理门诊的86例DD、175例SLI、142例ASD的CSBS-DP-ITC结果进行比较分析,年龄均在12~24个月。"
				],
				"title": "测试目的"
			},
			"style": "cs7"
	...
	[
		{
			"data": {
				"desc1": "我是一个合格的父母吗，我给孩子提供了丰厚的物质条件，我还有什么不足之处？",
				"desc2": "这是一个针对父母的育儿技能评估表，旨在帮助父母了解自己的育儿能力，发现并改进不足之处，提高育儿质量"
			},
			"style": "cs6"
		},
		{
	...
	[
		...
		{
			"data": {
				"desc1": "多动症是由于遗传因素、心理因素、家庭教育因素等多方面原因综合作用引起的。其中遗传因素最为常见，患儿的父母双方有一方年幼时有多动症，孩子多动症的发生率会比较高。环境因素也占很大的比例，如果家庭环境嘈杂、父母性格怪异、家庭教育不当等都可能影响到本病的发生。",
				"desc2": "本测试根据DSM诊断标准的SNAP-IV。SNAP-N评定量表主要用于6~18岁儿童青少年的ADHD 筛选、辅助诊断以及治疗疗效与症状改善程度的评估,为父母、教师共用,完成约需时10分钟。",
				"title": "多动症的成因"
			},
			"style": "cs6"
		},
		{
			"data": {
				"list": [
					{
						"desc": "感觉小孩子比较调皮，不知道是单纯的调皮还是有多动症，纠结于要不要上医院检查的家长，可以用本测试作为参考，如果测试不通过，建议去正规医院做进一步检查"
					}
				],
				"title": "适合谁测"
			},
		...
		},
		{
			"data": {
				"list": [
					{
						"desc": "杰弗里 .(2010).E·杨，崔丽霞等译。图式治疗:实践指南，世界图书出版公司"
					},
					{
						"desc": "Assessment of early maladaptive schemas:Apsychometric study of the Turkish YoungSchema Questionnaire-Short Form-3"
					},
					{
						"desc": "Cecero,J.J..Nelson,J.D.，& Gillie,J.M.(2004)Tools and tenets of schema therapy: toward theconstruct validity of the early maladaptiveschema questionnaire-research version(EMSQ-R).Clinical Psychology &Psychotherapy: An InternationalJournal ofTheory & Practice，11(5),344-357."
					},
					{
						"desc": "Knights，D.,& Willmott,H.(1989).Power andsubjectivity at work: From degradation to subjugation in social relations.Sociology,23(4)535-558"
					},
					{
						"desc": "MacCarthy，D.(1979). Recognition of signs ofemotional deprivation: A form of child abuse.Child Abuse & Neglect，3(2),423-428"
					}
				],
				"title": "参考文献"
			},
	...
	[
		{
			"data": {
				"desc1": "长处和艰苦问卷(SDQ)是由美国心理学家 Goodman R于1997年编制的一个简明的行动筛查问卷.该量表在国内由上海市精力卫生中间杜亚松等进行了修订并制订了上海常模",
				"desc2": "该问卷用于4-16岁儿童，综合测评儿童品行，注意力，同伴交往，社会行为，以及儿童的情绪问题和长处，请根据您孩子过去6个月实际情况填写"
			},
			"style": "cs6"
		},
		{
	...
	[
		{
			"data": {
				"list": [
					"多发性抽动症综合量表(Tourette SyndromeGlobal Scale, TSGS)是一个由临床医生完成的症状调查量表。于1984年由Harcherik等编制,基于医生在临床访问时的直接观察或者从患者及其家属那里所获得的资料制定,由于多方面的信息被利用,这种类型的评定量表是比较好的评估方式。"
				],
				"title": "背景"
			},
			"style": "cs7"
		},
		{
			"data": {
				"list": [
					"多发性抽动症综合量表是一个评估多发性抽动症症状和社会功能的多维量表,由8个单维量表组成,其中抽动方面主要包括4个单维量表:简单运动性抽动、复杂运动性抽动、简单发声性抽动、复杂发,声性抽动。每个单维量表用于评估抽动的频度(分0~5级)和干扰的程度(分1~5级),对每一类抽动,其频度分和干扰分是多样的,最后要合计成一个总分。社会功能方面主要包括3个单维量表:行为问题、运动不宁、学习或工作情况。社会维度由0(无损害)至25(严重损害)连续等级分组成。"
				],
				"title": "测评详情"
			},
			"style": "cs7"
